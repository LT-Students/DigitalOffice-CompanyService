    ...
    public class Startup : BaseApiInfo
    {
        ...
        private void ConfigureMassTransit(IServiceCollection services)
        {
            services.AddMassTransit(x =>
            {
                ...
                x.AddConsumer<GetUsersDepartmentsAndPositionsConsumer>();
            ...
            IRabbitMqBusFactoryConfigurator cfg)
        {
            ...
            cfg.ReceiveEndpoint(_rabbitMqConfig.GetUsersDepartmentsAndPositionsEndpoint, ep =>
            {
                ep.ConfigureConsumer<GetUsersDepartmentsAndPositionsConsumer>(context);
            });
        }
